...
$sql = "UPDATE user SET verification_status = 'Verified' WHERE user_id = '$uid'";
...
$uid = $_POST['uid'];
$email = $POST['user_email'];
$sql = "UPDATE user SET verification_status = 'Rejected'WHERE user_id = '$uid'";
        $result = mysqli_query($conn, $sql); 
        if($result){
            $_SESSION['status_icon'] = "error";
            $_SESSION['status_title'] = "Rejected!";
