<?php
    ...
    // count jobs posted
    $sql_query2 = "SELECT count(post_id) as jobs_posted FROM jobs_post WHERE employer_id ='$user_id'";
    $result2 = $conn->query($sql_query2);
    while($row2 = $result2->fetch_array()){   
        $jobs_posted = $row2['jobs_posted']; 
    }
    // count all employees
    $sql_query3 = "SELECT count(user_id) as employees FROM applicants WHERE employer_id ='$user_id'";
    $result3 = $conn->query($sql_query3);
    while($row3 = $result3->fetch_array()){    
        $total_employees = $row3['employees']; 
    }

    // availabl users
    $sql_query4 = "SELECT count(user_id) as available_users from user WHERE mode ='work'";
    $result4 = $conn->query($sql_query4);
    while($row4 = $result4->fetch_array()){    
         $available_users = $row4['available_users']; 
    }
        // Chart
    $dataPoints = array(
...
<head>
    ...
    <title>Available Job Seekers</title>
...
<body class="vertical-layout vertical-menu-modern content-detached-left-sidebar navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="content-detached-left-sidebar">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" active"><a class="d-flex align-items-center" href="available-user.php"><i data-feather="users"></i><span class="menu-title text-truncate" data-i18n="jobseekers">Job Seekers</span></a>
                </li>   
    ...
    <div class="app-content content ecommerce-application">
                            ...
                            <div class="col-sm-12">
                                <div class="ecommerce-header-items">
                                    <div class="result-toggler">
                                        ...
                                        <div class="search-results"><?=$available_users?> results found</div>
                                    </div>
                        ...
                        <div class="row mt-1">
                            <div class="col-sm-12">
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control search-product" id="shop-search" placeholder="Search Employee" aria-label="Search..." aria-describedby="shop-search" />
                    ...
                    <section id="ecommerce-products" class="grid-view">
                        <?php 
                            $sql_work = "SELECT * FROM user WHERE mode ='work' ORDER BY rand()";
                            $results_work = mysqli_query($conn, $sql_work);
                            while($fetch = $results_work->fetch_array()){
                                ...
                                $sql_credentials = "SELECT * FROM credentials WHERE `user_id` = '$users_id'";
                                $result_credentials = mysqli_query($conn, $sql_credentials);

                        ?>
                            <div class="card ecommerce-card">
                                <div class="d-flex item-img text-center">
                                    <a href="view-user-profile.php?id=<?= $users_id?>">
                                        <img class="img-fluid card-img-top justify-center" src="../img/profile/<?= $pictures?>" style="width: 30rem; height: 15.5rem; margin-top: -12px;" alt="img-placeholder"/></a>
                                </div>
                                <div class="card-body">
                                    <div class="item-wrapper">
                                        <div>
                                            <h2 class="item-price"><?= $title?></h2>
                                        </div>
                                    </div>
                                    <h4 class="item-name">
                                        <a class="#_" href="jobs-post.php"><?= $fname?></a>
                                    </h4>
                                </div>
                                <div class="item-options text-center">
                                    ...
                                    <a href="#_" 
                                        ...
                                        <span class="add-to-cart">Hire</span>
                                    </a>
                                </div>
                            </div>
                        <?php }?>
...
var chart = new CanvasJS.Chart("chartContainer", {
    ...
    data: [{
        ...
        yValueFormatString: "Employees: #,##0",
