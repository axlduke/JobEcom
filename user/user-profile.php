                                    ...
                                    <div class="tab-pane active" id="about" aria-labelledby="home-tab" role="tabpanel">
                                        ...
                                        <div class="row row-cols-2 ml-1">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <a href="../img/credentials/<?= $rows['pdf_file']?>" download="<?= $rows['pdf_file']?>" class="badge badge-pill badge-light-info"><?= $certificate?></a>
                                            </div>
                                            <div class="mt-2">
                                                <h5 class="mb-75">Resume</h5>
                                                <a href="../img/credentials/<?= $rows['pdf_file']?>" download="<?= $pdf_file?>" class="badge badge-pill badge-light-info"><?= $pdf_file?></a>
                                            </div>
                                          <div class="mt-2">
                                                <h5 class="mb-75">Cover</h5>
                                                <a href="../img/credentials/<?= $rows['pdf_file']?>" download="<?= $pdf_cover?>" class="badge badge-pill badge-light-info"><?= $cover?></a>
                                            </div>                                            
                                        </div>
                                    </div>
                                    <?php
