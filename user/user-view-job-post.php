            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Job Description</h2>
                ...
                <div class="content-body">
                    ...
                    <div class="blog-detail-wrapper">
                        <div class="row">
                            <!-- Blog -->
                            <?php
                                $jobs_applied = "SELECT jobs_post.*, user.fname as fname, user.pictures as pictures from jobs_post inner join user on user.user_id = jobs_post.employer_id where post_id = '$post'";
                                $res=mysqli_query($conn, $jobs_applied);
                                if($r=mysqli_fetch_array($res)){
                                    $query ="SELECT * FROM applicants WHERE user_id = '$user_id' and job_id = '$post'";
                                    ...
                                    if(mysqli_num_rows($results) > 0){
                                        if($rows=mysqli_fetch_array($results)){
                                            ...
                                            $status = $rows['status'];
                                                if($status == 'Pending'){
                                                    $status = '
                                                        <h7 class="card-title">Applicant Status: </h7>
                                                        <a href="javascript:void(0);">
                                                            <label class="badge badge-glow badge-warning mr-50">Pending</label>
                                                        </a>';
                                                } elseif($status == 'Accepted'){
                                                    $status = '
                                                        <h7 class="card-title">Applicant Status: </h7>
                                                        <a href="javascript:void(0);">
                                                            <label class="badge badge-glow badge-success">Accepted</label>
                                                        </a>';
                                                } elseif($status == 'Declined'){
                                                    $status = '
                                                        <h7 class="card-title">Applicant Status: </h7>
                                                        <a href="javascript:void(0);">
                                                            <label class="badge badge-glow badge-danger">Declined</label>
                                                        </a>';
                                                }
                                            }
                                            elseif($rows['status']==null){$status ='';
                                            }
                                        }
                                    }else{ $status =  ''; }
                            ?>
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="avatar mr-50">
                                                <img src="../img/profile/<?php echo $r['pictures']?>" width="50" height="50" />
                                            </div>
                                            <div class="media-body">
                                                <!-- <small class="text-muted mr-25"></small> -->
                                                <small><a href="javascript:void(0);" class="text-body"><?= $r['fname']?></a></small>

                                                <span class="text-muted ml-50 mr-25">|</span>
                                                <small class="text-muted"><?= $r['date_posted']?></small><br>
                                        ...
                                        <p class="card-text mt-2 mb-2">
                                            ...
                                            if ($status!=null) {
                                                if($rows['status']=='Pending'){
                                                    echo '<a href="../auth/jobs/delete-applied-job.php?job_post='.$post.'" class="btn btn-danger mr-1"><span>&nbsp;&nbsp; Cancel &nbsp;&nbsp;&nbsp</span></a>';
                                                }
                                                else{
                                                    echo'';
                                                }
                                                ...
                                                <input name="employer_id" class="hidden" type="text" value="'.$r['employer_id'].'">
