                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mb-1">Adventure starts here 🚀 EMPLOYER</h4>
                                        ...
                                        <form action="../auth/register-auth.php" method="post" role="form" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="tel" name="contact" class="form-control" placeholder="Contact Number" maxlength="11"/>
                                                        </div>
                                                    </div>
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="file" name="front" accept="image/*" placeholder="valid id"required/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="d-block">Valid ID: Back</label>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="file" name="back" accept="image/*" placeholder="valid id" required/>
                                                        </div>
                                                    </div>                                                    
                                                    <div class="form-group">
                                                        <label class="d-block">Proof Of Employment</label>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="file" name="bir" accept="image/*" required/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
