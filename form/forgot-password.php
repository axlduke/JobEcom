                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <form class="auth-forgot-password-form mt-2" action="../auth/reset-password.php" method="POST">
                                    <div class="form-group">
                                        <label for="forgot-password-email" class="form-label">Email <?php if(isset($_SESSION['failed'])) { echo $_SESSION['failed']; unset($_SESSION['failed']);} ?></label>
                                    ...
                                    <button name="send" type="submit" class="btn btn-primary btn-block" tabindex="2">Send reset link</button>
                                </form>
