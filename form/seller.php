                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mb-1">Adventure starts here 🚀 Seller</h4>
                                    ...
                                    <div class="row">
                                        <form action="../auth/register-auth.php" method="post" role="form" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="fname" type="text" class="form-control" id="basic-default-name"  required/>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-label" for="basic-default-email">Email</label>
                                                            <input name="email" type="text" id="basic-default-email" class="form-control" required/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group input-group-merge form-password-toggle">
                                                                <input class="form-control form-control-merge" id="txtPassword" type="password" name="password" placeholder="············" aria-describedby="register-password" tabindex="3" required/>
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <div class="input-group input-group-merge form-password-toggle">
                                                                <input class="form-control form-control-merge" id="txtConfirmPassword" type="password" name="password" placeholder="············" aria-describedby="register-password" tabindex="3" required/>
                                                                <div class="input-group-append"><span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-label" for="basic-default-name">Shop Name</label>
                                                            <input name="business" type="text" class="form-control" id="basic-default-name"  required/>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <button type="submit" class="btn btn-primary" name="seller">Submit</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
    ...
    <script type="text/javascript">
        function Validate() {
            ...
            if (password != confirmPassword) {
                alert("Passwords do not match. please check password");
                return false;
            }
            return true;
        }
